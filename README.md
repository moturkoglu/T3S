...
📄 **Paper:** [arXiv:2506.12885](https://arxiv.org/abs/2506.12885)
...
The cumulative growing degree days up to day $d$ are then

$$
\mathrm{cGDD}_d =
\sum_{i=1}^{d} \mathrm{GDD}_i.
$$
...
📄 **[Read the paper on arXiv](https://arxiv.org/abs/2506.12885)**
...
This entry cites the current arXiv version. It can be replaced with the final proceedings citation once available.
